...
#Data paths
path_data = './data/ONEPan'

# Create a QR code object
qr = qrcode.QRCode(version=1, box_size=10, border=5)

# Define the data to be encoded in the QR code
data = "http://172.25.113.64:8501/?Company=ONEPan&Product_ID=1"
...
logo = Image.open(os.path.join(path_data, "logo.png")) 
...
img.save(os.path.join(path_data,"qr_3.png"))